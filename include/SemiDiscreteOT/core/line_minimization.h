...
#ifndef wasserstein_line_minimization_h
#define wasserstein_line_minimization_h
 ...
 */
namespace WassersteinLineMinimization
{
  /**
   ...
   *   const auto res = WassersteinLineMinimization::line_search<double>(
   *     func,
...
#endif // wasserstein_line_minimization_h
