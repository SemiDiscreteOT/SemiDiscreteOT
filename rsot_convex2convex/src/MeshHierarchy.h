...
public:
     ...
     */
    int generateHierarchyFromFile(const std::string& input_mesh_file, const std::string& output_dir);
...
private:
     ...
     */
    bool loadVolumeMesh(const std::string& filename, GEO::Mesh& M) const;
